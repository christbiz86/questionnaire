...
@section('content')
    <h3 class="page-title">@lang('quickadmin.questions.invite')</h3>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('option1', 'Email #1', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('option2', 'Email #2', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('option3', 'Email #3', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('option4', 'Email #4', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('option5', 'Email #5', ['class' => 'control-label']) !!}
    ...
    {!! Form::submit(trans('quickadmin.sent_invite'), ['class' => 'btn btn-danger']) !!}
    {!! Form::close() !!}
@stop
